            ...
            <div class="card bg-white h-100 shadow-sm">
                <div class="card-body row g-0">
                    <div class="col-sm-5 pe-sm-4">
                        ...
                        <span class="badge bg-label-primary">+{{ $summaries->sum('available_actual') }} Available</span>
                    ...
                    <div class="col-sm-7 ps-sm-4 pt-2">
                        @foreach ($summaries as $counter)
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2" data-bs-toggle="tooltip"
                                ...
                                <small>{{ $counter->available_actual }}</small>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="card bg-white h-100 shadow-sm">
                <div class="card-body row g-0">
                    <div class="col-sm-5 pe-sm-4">
                        ...
                        <p class="mb-1">
                            <span class="me-2">{{ $summaries->sum('available_actual') }} Available</span>
                        ...
                        @foreach ($summaries as $counter)
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex justify-content-between small">
                                    <span class="text-primary">Available: {{ $counter->available_actual }}</span>
                    ...
                    <tbody>
                        @forelse ($employeeRequests as $employee)
                            <tr class="shadow-sm">
                                ...
                                <td class="text-center">
                                    <span
                                        class="badge bg-secondary rounded-pill">{{ $employee->non_requested_count }}</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Handle department filter change for Admins
                @if (Auth::user()->hasRole('Admin'))
