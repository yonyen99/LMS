                    ...
                    <div class="col-sm-7 ps-sm-4 pt-2 scrollable-leave-types">
                        @forelse ($summaries as $summary)
                            ...
                            <div class="d-flex align-items-center gap-2 mb-2" data-bs-toggle="tooltip"
                                ...
                                <small class="w-50 text-truncate">{{ $summary->leaveType->name }}
                                    ({{ $summary->entitled }})
                                </small>
                                ...
                                <small>{{ number_format($summary->available_actual, 1) }}</small>
                            </div>
                        @empty
            ...
            <div class="card bg-white h-100 shadow-sm">
                <div class="card-body row g-0">
                    ...
                    <div class="col-sm-7 ps-sm-4 pt-2 scrollable-leave-types">
                        @forelse ($summaries as $summary)
                            @php
                                $total = $summary->entitled ?: 1;
                                $availablePercent = ($summary->available_actual / $total) * 100;
                            @endphp
                            <div class="mb-4">
